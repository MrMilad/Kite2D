...
namespace Kite{
	...
	public:
		...
		static bool loadFile(const std::string &FileName, std::vector<KCellBitmapTypes> &Objects);

		// save objects to ktb file
		static void saveFile(const std::string &FileName, const std::vector<KCellBitmapTypes> &Objects);
	};
}
