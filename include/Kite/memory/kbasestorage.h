...
USA
*/
#ifndef KBASESTORAGE_H
#define KBASESTORAGE_H

#include "Kite/core/kcoredef.h"
#include <new>

namespace Kite {
	class KITE_FUNC_EXPORT KBaseStorage {
	public:
		KBaseStorage(SIZE Size, void * Start) {
			_kstart = Start;
			_ksize = Size;
	...
	// smart pointers deleter
	template <typename T>
	struct StorageDeleter {
		KBaseStorage *storage;
		void operator()(T *p){
			p->~T();
