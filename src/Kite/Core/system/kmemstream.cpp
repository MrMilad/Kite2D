...
namespace Kite{
	KMemStream::KMemStream(const void *Data, U64 DataSize) :
		_kdata(Data),
		_ksize(DataSize),
		_kcurOfst(0)
	{}

	U64 KMemStream::read(void *Data, U64 DataSize){
	...
	I32 KMemStream::seek(I64 Offset, I32 Origin){
		if (!_kdata)
			return -1;
