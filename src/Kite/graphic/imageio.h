    ...
    public:
		...
		*/
		...
		/*!
			...
			\return True if loading was successful
		*/
		static bool readFromStream(KIOStream &Stream, const std::string &Address, std::vector<U8> &Pixels, KVector2U32 &Size);
		...
		*/
		...
		static bool writeToStream(KIOStream &Stream, const std::string &Address, const std::vector<U8> &Pixels, const KVector2U32 &Size);
